...
(async () => {
    ...
    try {
        ...
        const KNOWN_OTHER = {
            spa_wiped: '退勤モードのフラグ', spa_open_settings_after_roster: 'sessionStorageのフラグ(名簿変更後の再読み込みで名簿設定を開く)', spa_storage_persisted: '永続ストレージ要求の結果フラグ', spa_classroom_db: 'IndexedDBのデータベース名',
